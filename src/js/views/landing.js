						...
						<div className="col-md-8 mt-3">
							<div className="card-body">
								...
								<p className="card-text">
									En cualquier rincón del país podrás acceder a las rutas más interesantes para vos,
									desde paseos hasta bici sendas y por que no, hacer tu propia ruta.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="row no-gutters">
						...
						<div className="col-md-8 mt-3">
							<div className="card-body">
								...
								<p className="card-text">
									¿Pinchaste la bici y no sabes dónde repararla? Donde te estés, encontrarás talleres
									con las mejores calificaciones para solucionar tu problema.
								</p>
							</div>
						</div>
					</div>
