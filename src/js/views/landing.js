...
export const Landing = () => {
	return (
		<div>
			<Carousel fade>
				<Carousel.Item>
					<img className="d-block w-100" src={carrusel2} alt="Salvando al mundo una pedaleada a la vez" />
					<Carousel.Caption>
						<h2 className="pb-3 d-none d-sm-none d-md-block" style={{ textShadow: "3px 3px #000000" }}>
							Salvando al mundo una pedaleada a la vez
						</h2>
						<Link to="/register" className="btn btn-primary mb-5">
							Unite
						</Link>
					</Carousel.Caption>
				</Carousel.Item>
				...
				<Carousel.Item>
					<img className="d-block w-100" src={carrusel1} alt="Enterate de todos los eventos" />
					<Carousel.Caption>
						<h2 className="pb-3 d-none d-sm-none d-md-block" style={{ textShadow: "3px 3px #000000" }}>
			...
			<div className="flex pt-5">
				<div className="text-center">
					<h2 className="text-center text-primary">Conectate y empezá a disfrutar</h2>
				</div>
				<div className="row featurette p-5">
						...
						<div className="row no-gutters">
							...
							<div className="col-md-8 mt-3">
								<div className="card-body">
									<h5 className="card-title text-primary">Descubrí caminos</h5>
					...
					<div className="col-md-6 mb-3">
						<div className="row no-gutters">
							...
							<div className="col-md-8 mt-3">
								<div className="card-body">
									<h5 className="card-title text-primary">Encontrá locales Bici-friendly</h5>
									<p className="card-text">
					...
					<div className="col-md-6 mb-3">
						<div className="row no-gutters">
							...
							<div className="col-md-8 mt-3">
								<div className="card-body">
									<h5 className="card-title text-primary">Repará tu bici</h5>
									<p className="card-text">
					...
					<div className="col-md-6 mb-3">
						<div className="row no-gutters">
							...
							<div className="col-md-8 mt-3">
								<div className="card-body">
									<h5 className="card-title text-primary">Enterate de lo que está pasando</h5>
									<p className="card-text">
